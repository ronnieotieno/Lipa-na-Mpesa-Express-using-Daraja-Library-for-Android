    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            val lnmExpress = LNMExpress(
                ...
                "174379",
                phoneNumber,
                "http://callbackurl.com/checkout.php", // call back url send back payload info if the transactions went through. Its important inorder to update ui after user has paid
                "001ABC",
                "Goods Payment"
            )
